  ...
  async up(queryInterface, Sequelize) {
    await queryInterface.bulkInsert('Spots', [
      ...
      },
      {
        ...
        name: 'Harebnb: The Perfect Getaway for Your Beloved Rabbit!',
        description: "Are you planning a vacation or a business trip but worried about who will take care of your rabbit or bunny? Look no further! Harebnb is here to provide a comfortable and enjoyable stay for your precious rabbits or bunnies while you're away. We understand that your bunnies are part of your family, and their well-being is of utmost importance. That's why we offer top-notch care in a safe and stimulating environment, ensuring your bunnies feel right at home. Our experienced and passionate staff members are well-versed in rabbit care. They know how to handle and interact with rabbits, providing them with the love, attention, and care they deserve. Each bunny has its own spacious and cozy hutch, complete with comfortable bedding, ample space to hop around, and hiding spots for privacy. We make sure your bunnies have a serene and secure environment to relax in. We understand the importance of a balanced diet for rabbits. Our knowledgeable staff will provide fresh hay, vegetables, and high-quality pellets according to your rabbit's dietary needs. Special dietary requirements? No problem! Just let us know, and we'll ensure your bunny's needs are met. Our dedicated staff keeps a close eye on your bunnies' health and well-being. We regularly check their appetite, behavior, and litter box habits to ensure they're happy and healthy during their stay. ",
        price: 50,
        category: 'Rabbit/Bunny Home',
      ...
      },
      {
        ...
        description: "Furry, feathery, or scaly, we welcome them all at Second Home Pet Retreat! We're passionate about animals and your beloved pet's comfort, safety, and happiness. We specialize in offering boarding services for a variety of pets, including dogs, cats, birds, rabbits, guinea pigs, reptiles, and more. Our dedicated team of animal enthusiasts is experienced in caring for multiple types of pets and is committed to ensuring the well-being of each and every friend that stays with us. Designed with great thought and care, our 16,500-square-foot pet boarding facility is filled with special touches that assure your pet’s comfort and safety while staying with us. Our boarding facility is air-conditioned and heated. We do not use evaporative 'swamp' coolers which do not produce the same level of home-like comfort to which your pet is accustomed. Skylights are located throughout the pet resort, bathing animal areas in natural light.  In addition to 24-hour staffing, our boarding facility also features fire sprinklers, fire alarms, and security monitoring devices, and our systems are monitored 24 hours a day. Our animal guests enjoy the sound of calming music, including smooth jazz and soft contemporary rhythms, during their stay.",
        price: 160,
      ...
      },
      {
        ...
        description: "Are you going on a trip and don’t have anywhere to leave your reptile pet? Slither and Stay is proud to offer overnight stays for your reptile pets! Our boarding services are limited to snakes, amphibians, turtles, and lizards. Leave your pets in the hands of expert caretakers when you go out of town, and relax knowing your animal is safe and sound with us! Your reptile friend will be carefully cared for by my husband, a veterinarian, and me, a veterinary technician. Our home has multiple temperature-controlled rooms that can be custom-tailored to your reptile needs. We specialize in daily cage cleanings and individualized care. THOUGH, you must supply your pet’s caging while boarding with us. Reptitle animals stress easily and if they can continue to be in their familiar cages and receive the same foods, it will limit their anxiety while in new surroundings. Also, bringing their own food helps to alleviate stomach upset usually associated with abrupt changes in diet. Owners of reptiles with special needs should speak with us before leaving their pets. We can happily administer any medications, supplements, or vitamins while your pet is boarding with us for a small additional daily fee. RESERVATIONS ARE REQUIRED. Our boarding service is very popular. If you must cancel your reservation, please do so at least 48 hours prior to the drop-off date.",
        price: 50,
      ...
      },
      {
        ...
        name: 'Pocket Pals: Guinea pigs, hamsters, rats, and chinchillas',
      ...
      },
      {
        ...
        description: "Thank you for considering Cavy Cove to board your guinea pig! My family and I are excited to care for and love your guinea pig or guinea pigs while you're away. At Cavy Cove, guinea pigs are always treated as if they were on vacation! Room service includes veggies for breakfast, hay for lunch, pellets for dinner, and a light veggie or fruit for snack at night. Of course, there is always an abundance of hay and water available in each piggie's habitat. Activities are important! We have plenty to keep your guinea pig busy! Friendly piggies get the chance to watch awesome movies (like G-Force) while munching on a salad. Usually, 3-5 guinea pigs get to watch a movie together on one of the tablets. Playtime is always a fun experience and gives your guinea pig(s) a chance to meet other piggies. Playtime is always supervised and can be done solo if your guinea pig isn’t into socializing. During their stay they will have their nails trimmed, their bottoms cleaned, and a nice brushing. For boys, if needed, we also clean up their oil/grease gland area. All guinea pig habitats are cleaned daily. If you have bonded piggies, they will be kept segregated from other bonded piggies so that there is less of a chance of unbonding. Upon request, we can send you text picture updates of your guinea pig(s) while you are away.",
        price: 40,
        category: 'Hamster/Guinea Pig Home',
      ...
      },
      {
        ...
        description: "Welcome to Cottontail Cottage, where all bunnies and rabbits are warmly embraced! I'm thrilled to announce the opening of my unique in-home bunny boarding services, designed for owners seeking a special place to care for their furry friends while they're away. With over 20 years of experience as a dedicated bunny owner, I am now retired and fully committed to providing exceptional care. Unlike traditional pet sitting arrangements where animals are left alone for extended periods, I ensure that your beloved pet is never left unattended. I provide all the necessary housing essentials, including organic, farm-fresh hay, litter boxes and litter, bedding, bowls, and hideaways. During your bunny's stay, they will enjoy a nutritious diet consisting of daily vegetables such as a mix of leafy greens, carrot, broccoli, green pepper and celery. Fresh hay and water will be provided daily as well. My home is filled with relaxing music, abundant sunshine, and ample space for play, ensuring a stimulating and enjoyable environment for your furry companion. I prioritize daily housekeeping and thoroughly disinfecting suites between guests to maintain a clean and healthy environment for all. Additionally, I will provide frequent photo updates, allowing you to stay connected with your bunny while you're away.",
        price: 80,
        category: 'Rabbit/Bunny Home',
        type: 'Rabbit Care',
        pets: 2,
