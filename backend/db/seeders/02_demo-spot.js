...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    return queryInterface.bulkInsert('Spots', [
      {
        ownerId: 1,
        address: '1175 Meetinghouse Rd',
        city: 'West Chester',
        state: 'PA',
        country: 'United States of America',
        lat: 39.89721833339124,
        lng: -75.61237604721958,
        name: 'Woofingham Palace',
        description: 'Fun-filled, friendly cage-free dog boarding home loved and cared by a family with three Kids and their labrador retriever.',
        price: 150.95,
        previewImage: 'https://i.pinimg.com/564x/ab/c0/c5/abc0c5064437fad847923d4345561984.jpg',
      },
      {
        ownerId: 1,
        address: '4 Gramercy Park West',
        city: 'New York',
        state: 'NY',
        country: 'United States of America',
        lat: 40.73858266990581,
        lng: -73.98605343508669,
        name: "Stuart's and SnowBall's Home",
